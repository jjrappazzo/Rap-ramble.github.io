...
ggplot(data=sumofsales, aes(x= Year)) +
  geom_line(aes(y= sum_global_sales,group=1,color="Total Sales"),size = 2, alpha = 0.5)+
  ...
  geom_line(aes(y= sum_others_sales,group=1,color="The Rest of the World"),size = 2, alpha = 0.5)+
...
games_totalsales <- games_totalsales %>%
